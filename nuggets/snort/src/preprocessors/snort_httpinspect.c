                              ...
                              char *ErrorString, int ErrStrLen)
{
    ...
    {
        SnortSnprintf(ErrorString, ErrStrLen,
                      "No argument to '%s' token.", MAX_SPACES);
     ...
     {
         SnortSnprintf(ErrorString, ErrStrLen,
                     "Invalid argument to '%s'.", MAX_SPACES);
    ...
    {
        SnortSnprintf(ErrorString, ErrStrLen,
                      "Invalid argument to '%s'. Valid range is 0 to 65535.", MAX_SPACES);
    ...
    */
    ...
    if(!strcmp(PROFILE, pcToken))
    {
        ...
        do
        {
            ...
            {
                iRet = ProcessMaxSpaces(ServerConf, ErrorString, ErrStrLen);
                if (iRet)
                {
                    return iRet;
                }
            ...
            else
            {
                SnortSnprintf(ErrorString, ErrStrLen,
                              ...
                              LOG_URI, LOG_HOSTNAME, MAX_SPACES);
